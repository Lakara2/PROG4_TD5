...
public class PhoneMapper {
    ...
    public Phone toDomain(td.example.prog4.employee.model.Phone fromView, String employeeId) {
    ...
    public td.example.prog4.employee.model.Phone toView(Phone fromDomain) {
        return td.example.prog4.employee.model.Phone.builder()
                .id(fromDomain.getId())
